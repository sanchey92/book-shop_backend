...
var Cart = /** @class */ (function () {
    ...
    Cart.getCart = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    Cart.addToCart = function (id, productPrice) { return __awaiter(void 0, void 0, void 0, function () {
        var cart, idx, existingProduct, updatedProduct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    existingProduct = cart.products[idx];
                    if (existingProduct) {
                        updatedProduct = __assign({}, existingProduct);
                        updatedProduct.quantity += 1;
                        cart.products = __spreadArrays(cart.products);
